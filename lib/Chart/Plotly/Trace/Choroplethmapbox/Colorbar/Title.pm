package Chart::Plotly::Trace::Choroplethmapbox::Colorbar::Title;
use Moose;
...
use Chart::Plotly::Trace::Choroplethmapbox::Colorbar::Title::Font;
...
has font => (
    is => "rw",
    isa => "Maybe[HashRef]|Chart::Plotly::Trace::Choroplethmapbox::Colorbar::Title::Font",
);
