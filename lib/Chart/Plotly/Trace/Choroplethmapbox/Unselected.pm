package Chart::Plotly::Trace::Choroplethmapbox::Unselected;
use Moose;
...
use Chart::Plotly::Trace::Choroplethmapbox::Unselected::Marker;
...
has marker => (
    is => "rw",
    isa => "Maybe[HashRef]|Chart::Plotly::Trace::Choroplethmapbox::Unselected::Marker",
);
