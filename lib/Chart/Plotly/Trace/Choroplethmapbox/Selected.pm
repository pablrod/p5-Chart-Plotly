package Chart::Plotly::Trace::Choroplethmapbox::Selected;
use Moose;
...
use Chart::Plotly::Trace::Choroplethmapbox::Selected::Marker;
...
has marker => (
    is => "rw",
    isa => "Maybe[HashRef]|Chart::Plotly::Trace::Choroplethmapbox::Selected::Marker",
);
