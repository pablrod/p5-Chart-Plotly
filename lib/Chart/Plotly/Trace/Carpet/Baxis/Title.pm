package Chart::Plotly::Trace::Carpet::Baxis::Title;
use Moose;
...
use Chart::Plotly::Trace::Carpet::Baxis::Title::Font;
...
has font => (
    is => "rw",
    isa => "Maybe[HashRef]|Chart::Plotly::Trace::Carpet::Baxis::Title::Font",
);
...
has offset => (
    is => "rw",
    isa => "Num",
    documentation => "An additional amount by which to offset the title from the tick labels, given in pixels. Note that this used to be set by the now deprecated `titleoffset` attribute.",
);
...
has text => (
    is => "rw",
    isa => "Str",
    documentation => "Sets the title of this axis. Note that before the existence of `title.text`, the title's contents used to be defined as the `title` attribute itself. This behavior has been deprecated.",
);
