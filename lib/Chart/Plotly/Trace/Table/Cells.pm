package Chart::Plotly::Trace::Table::Cells;
use Moose;
...
Chart::Plotly::Trace::Table::Cells
...
has fill => (
    is => "rw",
    isa => "Maybe[HashRef]|Chart::Plotly::Trace::Table::Cells::Fill",
);
...
has font => (
    is => "rw",
    isa => "Maybe[HashRef]|Chart::Plotly::Trace::Table::Cells::Font",
);
...
has line => (
    is => "rw",
    isa => "Maybe[HashRef]|Chart::Plotly::Trace::Table::Cells::Line",
);
