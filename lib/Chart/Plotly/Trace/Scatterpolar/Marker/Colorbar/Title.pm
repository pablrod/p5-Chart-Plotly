package Chart::Plotly::Trace::Scatterpolar::Marker::Colorbar::Title;
use Moose;
...
use Chart::Plotly::Trace::Scatterpolar::Marker::Colorbar::Title::Font;
...
has font => (
    is => "rw",
    isa => "Maybe[HashRef]|Chart::Plotly::Trace::Scatterpolar::Marker::Colorbar::Title::Font",
);
