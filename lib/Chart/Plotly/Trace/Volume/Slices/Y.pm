package Chart::Plotly::Trace::Volume::Slices::Y;
use Moose;
...
has locations => (
    is => "rw",
    isa => "ArrayRef|PDL",
    documentation => "Specifies the location(s) of slices on the axis. When not specified slices would be created for all points of the axis y except start and end.",
);
