package Chart::Plotly::Trace::Volume::Legendgrouptitle;
use Moose;
...
use Chart::Plotly::Trace::Volume::Legendgrouptitle::Font;
...
has font => (
    is => "rw",
    isa => "Maybe[HashRef]|Chart::Plotly::Trace::Volume::Legendgrouptitle::Font",
);
