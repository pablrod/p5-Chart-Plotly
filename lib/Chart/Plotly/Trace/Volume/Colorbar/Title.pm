package Chart::Plotly::Trace::Volume::Colorbar::Title;
use Moose;
...
use Chart::Plotly::Trace::Volume::Colorbar::Title::Font;
...
has font => (
    is => "rw",
    isa => "Maybe[HashRef]|Chart::Plotly::Trace::Volume::Colorbar::Title::Font",
);
