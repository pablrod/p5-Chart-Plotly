package Chart::Plotly::Trace::Volume::Caps;
use Moose;
...
use Chart::Plotly::Trace::Volume::Caps::X;
...
has x => (
    is => "rw",
    isa => "Maybe[HashRef]|Chart::Plotly::Trace::Volume::Caps::X",
);
...
has y => (
    is => "rw",
    isa => "Maybe[HashRef]|Chart::Plotly::Trace::Volume::Caps::Y",
);
...
has z => (
    is => "rw",
    isa => "Maybe[HashRef]|Chart::Plotly::Trace::Volume::Caps::Z",
);
