package Chart::Plotly::Trace::Violin::Legendgrouptitle;
use Moose;
...
use Chart::Plotly::Trace::Violin::Legendgrouptitle::Font;
...
has font => (
    is => "rw",
    isa => "Maybe[HashRef]|Chart::Plotly::Trace::Violin::Legendgrouptitle::Font",
);
