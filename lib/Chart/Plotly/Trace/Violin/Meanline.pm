...
Chart::Plotly::Trace::Violin::Meanline
...
has visible => (
    is => "rw",
    isa => "Bool",
    documentation => "Determines if a line corresponding to the sample's mean is shown inside the violins. If `box.visible` is turned on, the mean line is drawn inside the inner box. Otherwise, the mean line is drawn from one side of the violin to other.",
);
