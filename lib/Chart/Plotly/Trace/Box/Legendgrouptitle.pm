package Chart::Plotly::Trace::Box::Legendgrouptitle;
use Moose;
...
use Chart::Plotly::Trace::Box::Legendgrouptitle::Font;
...
has font => (
    is => "rw",
    isa => "Maybe[HashRef]|Chart::Plotly::Trace::Box::Legendgrouptitle::Font",
);
