package Chart::Plotly::Trace::Scattersmith::Marker::Colorbar::Title;
use Moose;
...
use Chart::Plotly::Trace::Scattersmith::Marker::Colorbar::Title::Font;
...
has font => (
    is => "rw",
    isa => "Maybe[HashRef]|Chart::Plotly::Trace::Scattersmith::Marker::Colorbar::Title::Font",
);
