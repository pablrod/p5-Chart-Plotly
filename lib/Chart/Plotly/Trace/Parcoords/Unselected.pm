package Chart::Plotly::Trace::Parcoords::Unselected;
use Moose;
...
use Chart::Plotly::Trace::Parcoords::Unselected::Line;
...
has line => (
    is => "rw",
    isa => "Maybe[HashRef]|Chart::Plotly::Trace::Parcoords::Unselected::Line",
);
