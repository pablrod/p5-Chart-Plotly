package Chart::Plotly::Trace::Parcoords::Domain;
use Moose;
...
Chart::Plotly::Trace::Parcoords::Domain
...
has column => (
    is => "rw",
    isa => "Int",
    documentation => "If there is a layout grid, use the domain for this column in the grid for this parcoords trace .",
);
...
has row => (
    is => "rw",
    isa => "Int",
    documentation => "If there is a layout grid, use the domain for this row in the grid for this parcoords trace .",
);
...
has x => (
    is => "rw",
    isa => "ArrayRef",
    documentation => "Sets the horizontal domain of this parcoords trace (in plot fraction).",
);
...
has y => (
    is => "rw",
    isa => "ArrayRef",
    documentation => "Sets the vertical domain of this parcoords trace (in plot fraction).",
);
