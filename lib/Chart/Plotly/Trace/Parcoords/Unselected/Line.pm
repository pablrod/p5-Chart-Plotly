...
has opacity => (
    is => "rw",
    isa => "Num",
    documentation => "Sets the opacity of unselected lines. The default *auto* decreases the opacity smoothly as the number of lines increases. Use *1* to achieve exact `unselected.line.color`.",
);
