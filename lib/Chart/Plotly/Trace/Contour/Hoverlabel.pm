package Chart::Plotly::Trace::Contour::Hoverlabel;
use Moose;
use MooseX::ExtraArgs;
use Moose::Util::TypeConstraints qw(enum union);

use Chart::Plotly::Trace::Contour::Hoverlabel::Font;
...
Chart::Plotly::Trace::Contour::Hoverlabel
...
has font => (
    is => "rw",
    isa => "Maybe[HashRef]|Chart::Plotly::Trace::Contour::Hoverlabel::Font",
);
