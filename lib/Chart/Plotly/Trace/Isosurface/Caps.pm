package Chart::Plotly::Trace::Isosurface::Caps;
use Moose;
...
use Chart::Plotly::Trace::Isosurface::Caps::X;
...
has x => (
    is => "rw",
    isa => "Maybe[HashRef]|Chart::Plotly::Trace::Isosurface::Caps::X",
);
...
has y => (
    is => "rw",
    isa => "Maybe[HashRef]|Chart::Plotly::Trace::Isosurface::Caps::Y",
);
...
has z => (
    is => "rw",
    isa => "Maybe[HashRef]|Chart::Plotly::Trace::Isosurface::Caps::Z",
);
