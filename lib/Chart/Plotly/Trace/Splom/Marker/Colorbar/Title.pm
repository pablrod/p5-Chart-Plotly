package Chart::Plotly::Trace::Splom::Marker::Colorbar::Title;
use Moose;
...
use Chart::Plotly::Trace::Splom::Marker::Colorbar::Title::Font;
...
has font => (
    is => "rw",
    isa => "Maybe[HashRef]|Chart::Plotly::Trace::Splom::Marker::Colorbar::Title::Font",
);
