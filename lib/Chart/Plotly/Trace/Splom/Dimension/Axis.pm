package Chart::Plotly::Trace::Splom::Dimension::Axis;
use Moose;
...
has matches => (
    is => "rw",
    isa => "Bool",
    documentation => "Determines whether or not the x & y axes generated by this dimension match. Equivalent to setting the `matches` axis attribute in the layout with the correct axis id.",
);
