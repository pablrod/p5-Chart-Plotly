package Chart::Plotly::Trace::Waterfall::Hoverlabel;
use Moose;
...
use Chart::Plotly::Trace::Waterfall::Hoverlabel::Font;
...
has font => (
    is => "rw",
    isa => "Maybe[HashRef]|Chart::Plotly::Trace::Waterfall::Hoverlabel::Font",
);
