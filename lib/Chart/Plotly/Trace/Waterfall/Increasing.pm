package Chart::Plotly::Trace::Waterfall::Increasing;
use Moose;
...
use Chart::Plotly::Trace::Waterfall::Increasing::Marker;
...
has marker => (
    is => "rw",
    isa => "Maybe[HashRef]|Chart::Plotly::Trace::Waterfall::Increasing::Marker",
);
