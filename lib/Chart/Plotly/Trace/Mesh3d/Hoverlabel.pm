package Chart::Plotly::Trace::Mesh3d::Hoverlabel;
use Moose;
use MooseX::ExtraArgs;
use Moose::Util::TypeConstraints qw(enum union);

use Chart::Plotly::Trace::Mesh3d::Hoverlabel::Font;
...
Chart::Plotly::Trace::Mesh3d::Hoverlabel
...
has font => (
    is => "rw",
    isa => "Maybe[HashRef]|Chart::Plotly::Trace::Mesh3d::Hoverlabel::Font",
);
