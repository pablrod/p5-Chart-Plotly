package Chart::Plotly::Trace::Heatmapgl::Hoverlabel;
use Moose;
...
use Chart::Plotly::Trace::Heatmapgl::Hoverlabel::Font;
...
Chart::Plotly::Trace::Heatmapgl::Hoverlabel
...
has font => (
    is => "rw",
    isa => "Maybe[HashRef]|Chart::Plotly::Trace::Heatmapgl::Hoverlabel::Font",
);
