package Chart::Plotly::Trace::Ohlc::Increasing;
use Moose;
use MooseX::ExtraArgs;
use Moose::Util::TypeConstraints qw(enum union);

use Chart::Plotly::Trace::Ohlc::Increasing::Line;
...
Chart::Plotly::Trace::Ohlc::Increasing
...
has line => (
    is => "rw",
    isa => "Maybe[HashRef]|Chart::Plotly::Trace::Ohlc::Increasing::Line",
);
