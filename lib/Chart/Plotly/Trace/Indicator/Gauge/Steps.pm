package Chart::Plotly::Trace::Indicator::Gauge::Steps;
use Moose;
...
use Chart::Plotly::Trace::Indicator::Gauge::Steps::Line;
...
has line => (
    is => "rw",
    isa => "Maybe[HashRef]|Chart::Plotly::Trace::Indicator::Gauge::Steps::Line",
);
