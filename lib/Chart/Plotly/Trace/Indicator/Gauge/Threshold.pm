package Chart::Plotly::Trace::Indicator::Gauge::Threshold;
use Moose;
...
use Chart::Plotly::Trace::Indicator::Gauge::Threshold::Line;
...
has line => (
    is => "rw",
    isa => "Maybe[HashRef]|Chart::Plotly::Trace::Indicator::Gauge::Threshold::Line",
);
...
has value => (
    is => "rw",
    isa => "Num",
    documentation => "Sets a treshold value drawn as a line.",
);
