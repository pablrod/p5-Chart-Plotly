package Chart::Plotly::Trace::Indicator::Domain;
use Moose;
...
has column => (
    is => "rw",
    isa => "Int",
    documentation => "If there is a layout grid, use the domain for this column in the grid for this indicator trace .",
);
...
has row => (
    is => "rw",
    isa => "Int",
    documentation => "If there is a layout grid, use the domain for this row in the grid for this indicator trace .",
);
...
has x => (
    is => "rw",
    isa => "ArrayRef|PDL",
    documentation => "Sets the horizontal domain of this indicator trace (in plot fraction).",
);
...
has y => (
    is => "rw",
    isa => "ArrayRef|PDL",
    documentation => "Sets the vertical domain of this indicator trace (in plot fraction).",
);
