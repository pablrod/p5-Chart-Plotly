package Chart::Plotly::Trace::Scatterpolargl::Marker::Colorbar::Title;
use Moose;
...
use Chart::Plotly::Trace::Scatterpolargl::Marker::Colorbar::Title::Font;
...
has font => (
    is => "rw",
    isa => "Maybe[HashRef]|Chart::Plotly::Trace::Scatterpolargl::Marker::Colorbar::Title::Font",
);
