package Chart::Plotly::Trace::Scattergl::Legendgrouptitle;
use Moose;
...
use Chart::Plotly::Trace::Scattergl::Legendgrouptitle::Font;
...
has font => (
    is => "rw",
    isa => "Maybe[HashRef]|Chart::Plotly::Trace::Scattergl::Legendgrouptitle::Font",
);
