...
use Chart::Plotly::Trace::Histogram2d::Ybins::ImpliedEdits;
...
Chart::Plotly::Trace::Histogram2d::Ybins
...
has impliedEdits => (
    is => "rw",
    isa => "Maybe[HashRef]|Chart::Plotly::Trace::Histogram2d::Ybins::ImpliedEdits",
);
