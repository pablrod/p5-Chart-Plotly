package Chart::Plotly::Trace::Histogram2d::Legendgrouptitle;
use Moose;
...
use Chart::Plotly::Trace::Histogram2d::Legendgrouptitle::Font;
...
has font => (
    is => "rw",
    isa => "Maybe[HashRef]|Chart::Plotly::Trace::Histogram2d::Legendgrouptitle::Font",
);
