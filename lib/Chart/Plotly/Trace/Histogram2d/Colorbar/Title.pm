package Chart::Plotly::Trace::Histogram2d::Colorbar::Title;
use Moose;
...
use Chart::Plotly::Trace::Histogram2d::Colorbar::Title::Font;
...
has font => (
    is => "rw",
    isa => "Maybe[HashRef]|Chart::Plotly::Trace::Histogram2d::Colorbar::Title::Font",
);
