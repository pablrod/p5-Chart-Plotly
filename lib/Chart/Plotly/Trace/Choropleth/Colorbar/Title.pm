package Chart::Plotly::Trace::Choropleth::Colorbar::Title;
use Moose;
...
use Chart::Plotly::Trace::Choropleth::Colorbar::Title::Font;
...
has font => (
    is => "rw",
    isa => "Maybe[HashRef]|Chart::Plotly::Trace::Choropleth::Colorbar::Title::Font",
);
