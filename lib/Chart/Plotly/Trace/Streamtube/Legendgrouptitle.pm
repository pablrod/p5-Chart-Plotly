package Chart::Plotly::Trace::Streamtube::Legendgrouptitle;
use Moose;
...
use Chart::Plotly::Trace::Streamtube::Legendgrouptitle::Font;
...
has font => (
    is => "rw",
    isa => "Maybe[HashRef]|Chart::Plotly::Trace::Streamtube::Legendgrouptitle::Font",
);
