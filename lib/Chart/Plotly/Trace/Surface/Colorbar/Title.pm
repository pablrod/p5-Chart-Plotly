package Chart::Plotly::Trace::Surface::Colorbar::Title;
use Moose;
...
use Chart::Plotly::Trace::Surface::Colorbar::Title::Font;
...
has font => (
    is => "rw",
    isa => "Maybe[HashRef]|Chart::Plotly::Trace::Surface::Colorbar::Title::Font",
);
