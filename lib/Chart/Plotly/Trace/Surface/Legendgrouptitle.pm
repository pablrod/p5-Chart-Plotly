package Chart::Plotly::Trace::Surface::Legendgrouptitle;
use Moose;
...
use Chart::Plotly::Trace::Surface::Legendgrouptitle::Font;
...
has font => (
    is => "rw",
    isa => "Maybe[HashRef]|Chart::Plotly::Trace::Surface::Legendgrouptitle::Font",
);
