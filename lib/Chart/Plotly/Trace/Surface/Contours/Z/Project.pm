package Chart::Plotly::Trace::Surface::Contours::Z::Project;
use Moose;
...
Chart::Plotly::Trace::Surface::Contours::Z::Project
...
has x => (
    is => "rw",
    isa => "Bool",
    documentation => "Determines whether or not these contour lines are projected on the x plane. If `highlight` is set to *true* (the default), the projected lines are shown on hover. If `show` is set to *true*, the projected lines are shown in permanence.",
);
...
has y => (
    is => "rw",
    isa => "Bool",
    documentation => "Determines whether or not these contour lines are projected on the y plane. If `highlight` is set to *true* (the default), the projected lines are shown on hover. If `show` is set to *true*, the projected lines are shown in permanence.",
);
...
has z => (
    is => "rw",
    isa => "Bool",
    documentation => "Determines whether or not these contour lines are projected on the z plane. If `highlight` is set to *true* (the default), the projected lines are shown on hover. If `show` is set to *true*, the projected lines are shown in permanence.",
);
